import 'package:resposividade/modules/event.dart';
...
class _CalanderPageState extends State<CalanderPage> {
  ...
  Future<bool> postLembretes() async {
    ...
    var anotacoes = "http://192.168.6.20:3010/lembretes";
    ...
    var response = await http.post(
      ...
      body: jsonEncode(<String, dynamic>{
        "title" : _lembreteController.text,
        "data" : date2,
        "start": date3,
        "end": date4
    ...
    if (response.statusCode == 201){
      ElegantNotification.success(description:Text('Lembrete criado com Sucesso!')).show(context);
      return true;
    } else {
      ElegantNotification.error(description:Text('Erro ao salvar')).show(context);
      return false;
    }
  }
}
